...
` : ''}
                ...
                <td class="p-6 text-[22px] font-bold text-[#7A6855]">
${mData.status === 'Paid' ? (mData.paidDate || '-') : '-'}
</td>
                                <td class="p-6 font-mono text-[25px]">${isOccupied ? `₹${mData.amount || 0}` : '-'}</td>
...
function togglePasswordVisibility(fieldId, buttonEl) {
    ...
    if (field.type === 'password') {
        ...
        field.type = 'password';
        buttonEl.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" style="pointer-events:none;"><path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0z"/><circle cx="12" cy="12" r="3"/></svg>`;
    }
}

// Expose functions globally for HTML inline event handlers (onclick, onchange, etc.)
